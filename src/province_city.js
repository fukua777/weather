function Province_city(box,province){
    ...
    cityArr[13] = [ '无锡市', '徐州市', '常州市', '苏州市', '南通市', '连云港市', '淮安市', '盐城市', '扬州市', '镇江市', '泰州市', '宿迁市' ];
    cityArr[14] = [ '温州市', '嘉兴市', '湖州市', '绍兴市', '金华市', '衢州市', '舟山市', '台州市', '丽水市']; 
    ...
    for(var i = 0; i < provinceArr.length; i++){
        ...
        option_province.innerHTML = provinceArr[i];
        province.appendChild(option_province);
    }

    province.addEventListener('change',function(){
        var province_sel = province.selectedIndex - 1;
        if(province_sel < 0){
            document.getElementsByClassName('city')[0].remove();
            return;
        }
        var city_arr = cityArr[province_sel];
        ...
        for(var z = 0; z < city_arr.length; z++){
            var option_city = document.createElement('option');
            option_city.innerHTML = city_arr[z];
            city.appendChild(option_city);
        }
        document.getElementById(box).appendChild(city);
